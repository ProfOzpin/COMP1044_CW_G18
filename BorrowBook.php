		...
		<?php
			...
			if($run == true){
				...
				if($index < (int) $number_of_copies){
					...
					echo "<h2 style=\"color:green;\">Request to borrow book has been approved! Your Borrow ID is " . $current_index . "</h2>";  
				} else {
					echo "<h2 style=\"color:red;\">The book cannot be borrowed at this moment, all copies are taken</h2>";
				}
